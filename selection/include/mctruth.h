...
namespace mctruth
{
     ...
     * @note See the GENIE/LArSoft documentation for the complete interaction
     * mode enumeration: https://code-doc.larsoft.org/docs/latest/html/MCNeutrino_8h_source.html
     */
    template<typename T>
     ...
     * typically producing one or more pions in the final state.
     * @tparam T the type of the object to apply the cut on.
     * @param obj the SRTrueInteraction to apply the cut on.
     ...
     * result in two nucleons being ejected without pion production.
     * @tparam T the type of the object to apply the cut on.
     * @param obj the SRTrueInteraction to apply the cut on.
